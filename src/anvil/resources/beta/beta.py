...
class BetaResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> BetaResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/Blueplanai/anvil#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> BetaResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/Blueplanai/anvil#with_streaming_response
        """

...
class TopicResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> TopicResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/Blueplanai/python-sdk#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> TopicResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/Blueplanai/python-sdk#with_streaming_response
        """

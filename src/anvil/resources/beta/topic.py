...
class TopicResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> TopicResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/Blueplanai/blueplan#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> TopicResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/Blueplanai/blueplan#with_streaming_response
        """
